...
- (void)weChatShareAction:(NSString *)title mp3Url:(NSString *)mp3 webUrl:(NSString *)web image:(UIImage *)image songWriter:(NSString *)writer {
    ...
    UIImage *finalThumbImage = [UIImage imageWithData:imageData];
    
    [message setThumbImage:finalThumbImage];
...
- (void)tmpRequest {
    ...
    //https://service.woyaoxiege.com/music/lrc/6640b93690ab192945763427d4d62518_5.lrc
    //https://service.woyaoxiege.com/core/home/data/getSongByCode?code=6640b93690ab192945763427d4d62518_5
    WEAK_SELF;
...
- (void)tryToRequestXianQuMid {
    if (![XWAFNetworkTool checkNetwork]) {
        [KVNProgress showErrorWithStatus:@"网络不给力"];
        return;
    } else if ([self.songModel.template_id isEqualToString:@"0"] || !self.songModel.template_id) {
        [KVNProgress showErrorWithStatus:@"未能获取时间信息"];
