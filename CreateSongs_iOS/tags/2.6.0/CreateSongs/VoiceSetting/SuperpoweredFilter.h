...
/**
 @brief Change parameters for resonant filters. 共振和共振频率
 */
    void setResonantParameters(float frequency, float resonance);
/**
 @brief Change parameters for shelving filters. 搁置滤波器
 */
    void setShelfParameters(float frequency, float slope, float dbGain);
/**
 @brief Change parameters for bandlimited filters. 频率 八度音阶宽度
 */
    void setBandlimitedParameters(float frequency, float octaveWidth);
/**
 @brief Change parameters for parametric filters.  频率 八度音阶宽度  分贝增益
 */
...
/**
 ...
 Resonant_Lowpass,  低通滤波器
 Resonant_Highpass, 高通滤波器
 Bandlimited_Bandpass 带通滤波器
 Bandlimited_Notch,
 LowShelf,          低架滤波器
 HighShelf,         高架滤波器
 Parametric
