...
@implementation HeadBarrageView
...
- (void)setUpCount:(NSString *)upCount {
    _upCount = upCount;
    self.upCountLabel.text = _upCount;
}
...
- (void)setHeadUrl:(NSString *)headUrl {
    _headUrl = headUrl;
    [self.headImageView sd_setImageWithURL:[NSURL URLWithString:headUrl] placeholderImage:[UIImage imageNamed:@"playUser头像"]];
}
