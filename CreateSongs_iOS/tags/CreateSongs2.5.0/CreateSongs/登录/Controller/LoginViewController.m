...
//    self.commitButton.backgroundColor = HexStringColor(@"#879999");
    ...
    UIImageView *QQImage = [[UIImageView alloc] initWithFrame:CGRectMake(0, fastLoginLabel.bottom + 27 * HEIGHT_NIT, 30 * WIDTH_NIT, 30 * WIDTH_NIT)];
    [self.view addSubview:QQImage];
    QQImage.center = CGPointMake(self.view.centerX, QQImage.centerY);
    QQImage.image = [UIImage imageNamed:@"QQ"];
    
    UIImageView *weixinImage = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 30 * WIDTH_NIT, 30 * WIDTH_NIT)];
    [self.view addSubview:weixinImage];
    weixinImage.center = CGPointMake(QQImage.centerX - 50 * WIDTH_NIT, QQImage.centerY);
    weixinImage.image = [UIImage imageNamed:@"微信"];
    
    UIImageView *weiboImage = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 30 * WIDTH_NIT, 30 * WIDTH_NIT)];
    [self.view addSubview:weiboImage];
    weiboImage.center = CGPointMake(QQImage.centerX + 50 * WIDTH_NIT, QQImage.centerY);
