...
- (void)viewDidLoad {
    ...
    [[EaseBaseMessageCell appearance] setSendBubbleBackgroundImage:[[UIImage imageNamed:@"聊天右气泡"] stretchableImageWithLeftCapWidth:5 topCapHeight:35]];//设置发送气泡
    [[EaseBaseMessageCell appearance] setRecvBubbleBackgroundImage:[[UIImage imageNamed:@"聊天左气泡"] stretchableImageWithLeftCapWidth:35 topCapHeight:35]];//设置接收气泡
