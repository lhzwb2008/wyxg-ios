...
- (void)viewDidLoad {
    ...
    if (self.recoderPath.length <= 0 || self.banzouPath.length <= 0 || self.recoderPath == nil || self.banzouPath == nil || ![fileManager fileExistsAtPath:self.recoderPath] || ![fileManager fileExistsAtPath:self.banzouPath]) {
    ...
    NSLog(@"%@-%@", self.banzouPath, self.recoderPath);
}
- (void)dealloc {
    NSLog(@"dealloc");
...
- (void)rightBtnAction:(UIButton *)btn {
    ...
    ///Users/axg/Library/Developer/CoreSimulator/Devices/7C802EE1-268B-4A9B-8DCB-74C6777432B7/data/Containers/Data/Application/C82E0AAC-A4FD-4423-9304-A1DFCCEAD6F9/Library/Caches/AXGCaches/282DA2AF374DBEEC23741374725CE7C1banzou.mp3
    [store putObject:@{
                       @"title":self.songName,
                       @"content":songContent,
                       @"saveTime":saveTime,
