...
@implementation ForumCommentFrameModel

- (void)setCommentsModel:(ForumCommentsModel *)commentsModel {
    ...
    CGSize contentSize = [self sizeWithString:_commentsModel.content font:JIACU_FONT(12*WIDTH_NIT) maxSize:CGSizeMake(SCREEN_W - self.userNameFrame.origin.x - rightPad/2-11*WIDTH_NIT, MAXFLOAT)];
    ...
    self.bgFrame = CGRectMake(leftPad, topPad + 22.5*WIDTH_NIT, SCREEN_W-leftPad-rightPad, contentSize.height + 30*WIDTH_NIT);
