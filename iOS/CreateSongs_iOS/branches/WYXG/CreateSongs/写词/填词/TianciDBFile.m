...
static NSTimeInterval cacheTime =  (double)9999999999;

@implementation TianciDBFile
+ (void) resetCache {
    [[NSFileManager defaultManager] removeItemAtPath:[TianciDBFile cacheDirectory] error:nil];
}
