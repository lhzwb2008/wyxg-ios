...
//    NSLog(@"%@", str);
    ...
    if (![[NSUserDefaults standardUserDefaults] boolForKey:@"homeGuidIsShowed"]) {
    
        [AXGGuidManager showHomeGuidUnderView:self.bottomButton];
    
        [self.bottomButton setImage:[UIImage imageNamed:@"创作icon2"] forState:UIControlStateNormal];
    
        [[NSUserDefaults standardUserDefaults] setBool:YES forKey:@"homeGuidIsShowed"];
        
        self.guidView = [AXGGuidManager sharedAXGGuidManager].homeGuidView;
    }
//    [AXGGuidManager showTYGuidUnderView:self.view];
//    
