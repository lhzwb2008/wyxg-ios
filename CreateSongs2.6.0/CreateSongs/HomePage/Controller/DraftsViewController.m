...
- (void)viewDidLoad {
    ...
    if (![[NSUserDefaults standardUserDefaults] boolForKey:@"draftsGuidIsShowed"]) {
        [[NSUserDefaults standardUserDefaults] setBool:YES forKey:@"draftsGuidIsShowed"];
        dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(1 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
            [AXGGuidManager showDraftsGuidUnderView:self.view];
        });
    }
}
