...
//    _titleBgView.backgroundColor = [UIColor redColor];
...
//    
//    self.titleBgView.frame = CGRectMake(0, 0, [AXGTools getTextWidth:self.titleLabel.text font:self.titleLabel.font], self.titleLabel.height);
//    self.titleBgView.center = CGPointMake(self.titleLabel.centerX, self.titleLabel.centerY);
//}
